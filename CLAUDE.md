...
**Tests — 841, all passing. No pytest**; each file runs standalone.
...
.venv/bin/python master/test_graph.py                #  80 — relation graphs: Source-only, fail-closed, no ghost rows
