...
**Tests — 954, all passing. No pytest**; each file runs standalone.
...
.venv/bin/python master/test_ontology.py             #  113 — YAML io: 왕복 보존, 안 바뀌면 안 씀 — relation graphs: Source-only, fail-closed, no ghost rows
