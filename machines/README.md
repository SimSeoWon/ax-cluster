...
| [`win-main-33.md`](win-main-33.md) | Windows **main work PC** (192.168.0.33, account `user`) | [중요] **copy** → `C:\Users\USER\CLAUDE.md` [완료] refreshed 2026-08-20 (12,034 B, MD5 identical — § 요청자 콘솔 · 도구 14종 · 은퇴분 포함) |
